...
class SparkWordCount extends RDDTransform {
   ...
   */
  override def getName: String = "Spark Word Count RDD Example"
   ...
   */
  override def getTypeId: String = "spark-word-count"
   ...
   */
  override def getDescription: String = "This is the spark-word-count Example"
