...
class AnalyzeSentiment extends DataFrameTransform {
  ...
  /**
    ...
    */
  override def getName: String = "analyze-sentiment"
  ...
  /**
    ...
    */
  override def getTypeId: String = "analyze-sentiment"
  ...
  /**
    ...
    */
  override def getDescription: String = "This is the analyze-sentimentp Example"
