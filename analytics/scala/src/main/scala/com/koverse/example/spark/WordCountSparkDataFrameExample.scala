...
class WordCountSparkDataFrameExample extends DataFrameTransform {
  ...
  /**
    ...
    */
  override def getName: String = "wordCountSparkDataFrameExample"
  ...
  /**
    ...
    */
  override def getTypeId: String = "wordCountSparkDataFrameExample"
