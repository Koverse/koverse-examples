...
class LogisticsRegressionTrain extends DataFrameTransform {
  ...
  /**
    ...
    */
  override def getName: String = "LogisticsRegressionTrain"
  ...
  /**
    ...
    */
  override def getTypeId: String = "logistic-regression-train"
  ...
  /**
    ...
    */
  override def getDescription: String = "This is the logistic-regression-train Example"
