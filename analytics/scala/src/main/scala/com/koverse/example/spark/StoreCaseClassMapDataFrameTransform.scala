...
class StoreCaseClassMapDataFrameTransform extends DataFrameTransform {
  ...
  /**
    ...
    */
  override def getDescription: String = "This is the Store Case Class Map DataFrame Example"
